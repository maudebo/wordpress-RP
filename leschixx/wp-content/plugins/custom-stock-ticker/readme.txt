...
The Custom Stock Ticker plugin creates customizable moving stock tickers that can be placed anywhere on a site using shortcodes. You can choose from multiple themes and customize the colors, size, speed, text, and symbols displayed. 
...
= How do I place the ticker into a sidebar-widget? =
...
* Fixed a typo in jquery animate code
