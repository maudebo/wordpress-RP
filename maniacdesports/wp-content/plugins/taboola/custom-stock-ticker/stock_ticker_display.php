...
function stock_ticker_scripts_enqueue($force = false) {
    ...
    //NOTE: modernizr is used for the fancy ticker scrolling effect
    wp_register_script('modernizr_custom',    plugins_url('modernizr_custom.js', __FILE__), array( 'jquery' ),    SP_CURRENT_VERSION, false);
    wp_register_script('stock_ticker_script', plugins_url('stock_ticker_script.js', __FILE__), array( 'jquery' ), SP_CURRENT_VERSION, false);
    wp_register_style ('stock_ticker_style',  plugins_url('stock_ticker_style.css', __FILE__), false,             SP_CURRENT_VERSION);
...
// TODO : updated stock_plugin_cache.php file refrences long names for data entries
// for example: ['stock_symbol'] instead of ['stock_sym']. this will need to be updated
